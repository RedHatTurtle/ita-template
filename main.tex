...
%%% $HeadURL: https://apgita.org.br/academico/teses-e-latex/
%%%
...
%\usepackage{amsthm}      % Ambinente para teoremas `\theorem`
...
% Arquivos de bibliografia para BibLatex (acho que podem ser vários)
\addbibresource{bib/itaTemplate_bibliography.bib}

\begin{document}
  % Inicia a contagem de paginas com numeração romana até "\mainmatter"
  \frontmatter
  ...
  % Agradecimentos
  \begin{itathanks}
    \input{texts/cap0/agradecimentos}
  \end{itathanks}
  ...
  \begin{abstract}
    \noindent
    \input{texts/cap0/resumo}
  \end{abstract}

  % Abstract (em inglês)
  \begin{englishabstract}
    \noindent
    \input{texts/cap0/abstract}
  \end{englishabstract}
  ...
  \input{texts/cap4/capitulo4.tex} % Resultados
  \input{texts/cap5/capitulo5.tex} % Conclusão

  % Referências Bibliográficas (implementação original, via natbib)
  %\renewcommand\bibname{\itareferencesnamebabel} % Renomear título do capítulo referências
  %\bibliography{bib/referencias.bib}

  % Referências Bibliográficas (nova implementação, via biblatex)
  % Aqui apenas informamos o ponto onde deve ser inclusa a bibliografia no texto
  % Os arquivos "*.bib" já foram incluidos anteriormente com o comando "addbibresource"
  \printbibliography[heading=bibintoc,title=\itareferencesnamebabel] % Renomear título do capítulo referências

  \appendix % Apêndices (opcional)
  % Caso os apêndices não sejam utilizados comentar ou remover os comandos `input`
  \input{texts/ape1/apendice1} % Remover ou comentar
  \input{texts/ape2/apendice2}

  \annex % Anexos (opcional)
  % Caso anexos não sejam utilizados comentar ou remover os comandos `input`
  \input{texts/ane1/anexo1}
  \input{texts/ane2/anexo2}
  ...
  \FRDitaresumo{\input{texts/cap0/resumo}}
